...
inline __device__ uint8x6_t fp32_vec_to_e3m2(float2 (&array)[4]) {
  ...
  __nv_fp6x2_storage_t p0 = __nv_cvt_float2_to_fp6x2(array[0], __NV_E3M2, cudaRoundNearest);
  __nv_fp6x2_storage_t p1 = __nv_cvt_float2_to_fp6x2(array[1], __NV_E3M2, cudaRoundNearest);
  __nv_fp6x2_storage_t p2 = __nv_cvt_float2_to_fp6x2(array[2], __NV_E3M2, cudaRoundNearest);
  __nv_fp6x2_storage_t p3 = __nv_cvt_float2_to_fp6x2(array[3], __NV_E3M2, cudaRoundNearest);
  uint64_t val = static_cast<uint64_t>(p0) |
...
void scaled_mxfp6_quant_sm120(
    at::Tensor& output, at::Tensor const& input, at::Tensor& output_sf) {
