...
#if defined(CUDA_VERSION) && (CUDA_VERSION >= 12080)
  __nv_fp4x2_storage_t p0 = __nv_cvt_float2_to_fp4x2(float2{array[0], array[1]}, __NV_E2M1, cudaRoundNearest);
  __nv_fp4x2_storage_t p1 = __nv_cvt_float2_to_fp4x2(float2{array[2], array[3]}, __NV_E2M1, cudaRoundNearest);
  __nv_fp4x2_storage_t p2 = __nv_cvt_float2_to_fp4x2(float2{array[4], array[5]}, __NV_E2M1, cudaRoundNearest);
  __nv_fp4x2_storage_t p3 = __nv_cvt_float2_to_fp4x2(float2{array[6], array[7]}, __NV_E2M1, cudaRoundNearest);
  uint32_t val = static_cast<uint32_t>(p0) |
...
#if defined(CUDA_VERSION) && (CUDA_VERSION >= 12080)
  __nv_fp4x2_storage_t p0 = __nv_cvt_float2_to_fp4x2(array[0], __NV_E2M1, cudaRoundNearest);
  __nv_fp4x2_storage_t p1 = __nv_cvt_float2_to_fp4x2(array[1], __NV_E2M1, cudaRoundNearest);
  __nv_fp4x2_storage_t p2 = __nv_cvt_float2_to_fp4x2(array[2], __NV_E2M1, cudaRoundNearest);
  __nv_fp4x2_storage_t p3 = __nv_cvt_float2_to_fp4x2(array[3], __NV_E2M1, cudaRoundNearest);
  uint32_t val = static_cast<uint32_t>(p0) |
                 (static_cast<uint32_t>(p1) << 8) |
                 (static_cast<uint32_t>(p2) << 16) |
                 (static_cast<uint32_t>(p3) << 24);
...
void scaled_nvfp4_quant_sm120(
    at::Tensor& output, at::Tensor const& input, at::Tensor& output_sf, at::Tensor const& input_sf) {
